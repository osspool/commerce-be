...
export type SizeGuideDocument = HydratedDocument<ISizeGuide>;
...
const SizeGuide = mongoose.models.SizeGuide || mongoose.model<ISizeGuide>('SizeGuide', sizeGuideSchema);
