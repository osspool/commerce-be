...
interface SeedCategoryDocument {
  name: string;
  slug: string;
  parent: string | null;
  description: string;
    ...
    subcategories: [
      {
        label: 'Tops',
        slug: 'tops',
        image: 'https://images.unsplash.com/photo-1564257631407-4deb1f99d992?w=100&h=100&fit=crop',
      },
      {
        label: 'Dresses',
        slug: 'dresses',
      ...
      },
      {
        label: 'Skirts',
        slug: 'skirts',
        image: 'https://images.unsplash.com/photo-1583496661160-fb5886a0uj3a?w=100&h=100&fit=crop',
      },
      {
        label: 'Accessories',
        slug: 'accessories',
        image: 'https://images.unsplash.com/photo-1611923134239-b9be5816e23c?w=100&h=100&fit=crop',
      },
    ],
  },
  kids: {
 ...
 */
function buildCategoryDocuments(): SeedCategoryDocument[] {
  const documents: SeedCategoryDocument[] = [];
  let displayOrder = 0;
