...
export const BASE_FOLDERS = ['general', 'products', 'categories', 'blog', 'users', 'banners', 'brands'];
...
export const IMAGE_SETTINGS = {
  ...
  allowedMimeTypes: ['image/jpeg', 'image/jpg', 'image/png', 'image/webp', 'image/gif', 'image/svg+xml', 'image/avif'],
