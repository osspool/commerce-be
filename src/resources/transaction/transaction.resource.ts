...
import transactionCrudSchemas, { transactionSchemaOptions } from './schemas.js';
import { events } from './events.js';
import { toArcSchemas } from '#shared/event-helpers.js';

// Import report handlers
import { getProfitLossReport, getCategoriesReport, getCashFlowReport } from './handlers/reports.handler.js';
...
const transactionResource = defineResource({
  ...
  customSchemas: toArcSchemas(transactionCrudSchemas),
