...
describe('E-commerce branch pin — opt-in via config.sales.ecomBranchId or a branch marked type:"ecommerce"', () => {
  it('getEcomBranchId() returns null when neither config nor a type:"ecommerce" branch exists (backward compatible)', async () => {
  ...
  it('getEcomBranchId() resolves a branch with type:"ecommerce" as the dedicated warehouse', async () => {
