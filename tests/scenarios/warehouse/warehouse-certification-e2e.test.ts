...
import { afterAll, beforeAll, describe, expect, it } from 'vitest'; import mongoose from 'mongoose'; import type { FastifyInstance } from 'fastify'; import { TestAuthProvider } from '@classytic/arc/testing';
import {
  bootScenarioApp,
...
function injectAs(auth: TestAuthProvider, method: string, url: string, payload?: unknown) {
...
async function getAvailability(auth: TestAuthProvider, skuRef: string) {
