...
import schemaGeneratorPlugin from '#common/plugins/schema-generator.plugin.js';
...
// Utilities
import sessionPlugin from '#common/plugins/session.plugin.js';
...
import responsePlugin from '#common/plugins/response.plugin.js';
