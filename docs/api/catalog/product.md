...
- `sizeGuide` (ObjectId) - Reference to size guide template. Use `?populate=sizeGuide` to fetch full size guide data. See [Size Guide API](../commerce/size-guide.md) for details.
